...
- [RIDB GDD review history](project_ridb-gdd-review-history.md) — resource-item-database.md: r1 NEEDS REVISION (7 blockers); r2 DEFECTS FOUND (AC3/EC4); r3 CLEAN — ready for Approved
- [Needs & Mood GDD review history](project_needs-mood-gdd-review-history.md) — r1 NEEDS REVISION: unspecified why-string contract, untested Edge Case 11, AC14/AC27 determinism defects
